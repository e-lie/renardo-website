---
title: Getting started - Renardo 1.0 alpha 
...
## Install Renardo as Python Package (to integrate it with python code)

- Install `renardo` using pip or your prefered python package manager.
- Execute `python3 -m renardo`, `py -m renardo` or similar depending on your python setup.

## Install Developpment version (to contribute or hack it)
